...
Some languages have more complicated pluralization rules than English speakers are used to. Words can be pluralized in way that English speakers would recognize from [ordinal numbers](https://en.wikipedia.org/wiki/Ordinal_number), like 20th, 21st, 22nd, 23rd. You can look these up in the table above.

As an example, these are the rules for Polish:

| Pluarlization | English | Polish | Numbers |
| :------------ | :------ | :----- | :------ |
